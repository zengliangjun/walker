...
class RewardsCfg:
    ...
    penalize_leg_joint_pos = rewards.RewardTermCfgWithCurriculum(
        ...
        params={
            "asset_cfg": SceneEntityCfg("robot"),
            "joint_names": ['left_hip_yaw_joint', 'left_hip_roll_joint', 'left_hip_pitch_joint',
                            'left_knee_joint',
            ...
            "feet_names": ['left_ankle_pitch_joint', 'left_ankle_roll_joint',
                           'right_ankle_pitch_joint', 'right_ankle_roll_joint'],
            "feet_weights": [0.5, 1, 0.5, 1],
        },
        start_weight=-.6,
        end_weight=-0.9
    )
    ...
    penalize_shoulder_joint_freeze_pos = rewards.RewardTermCfgWithCurriculum(
        ...
        params={
            "asset_cfg": SceneEntityCfg("robot"),
            "joint_names": ['left_shoulder_yaw_joint',  'left_shoulder_roll_joint', 'left_shoulder_pitch_joint', 'left_elbow_joint',
                            'right_shoulder_yaw_joint', 'right_shoulder_roll_joint', 'right_shoulder_pitch_joint', 'right_elbow_joint'
                            ],
    ...
    penalize_joint_deviation_torso = rewards.RewardTermCfgWithCurriculum(
        func=mdp.joint_deviation_l1, weight=-5,
...
class TerminationsCfg:
    ...
    body_contact = DoneTerm(
        ...
        params={"sensor_cfg": SceneEntityCfg("contact_forces",
                body_names=[".*torso_link", ".*knee_link",
                            #".*shoulder_pitch_link",
                            #".*shoulder_roll_link",
                            #".*shoulder_yaw_link",
                            #".*wrist_pitch_link",
...
class LocomotionVelocityRoughEnvCfg(ManagerBasedRLEnv_ExtendsCfg):
    ...
    # Scene settings
    scene: velocity_env_cfg.MySceneCfg = velocity_env_cfg.MySceneCfg(num_envs=4096, env_spacing=2.5)
    # Basic settings
...
class StyleLatentEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.robot = unitree.UNITREE_GO129FIXEDWRIST_FULLCOLLISION_CFG.copy().replace(prim_path="{ENV_REGEX_NS}/Robot")
