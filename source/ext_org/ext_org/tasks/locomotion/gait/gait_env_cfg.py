...
from isaaclabex.envs.mdp import gait_rewards
...
class CommandsCfg:
    ...
    base_velocity = commands_cfg.GaitCommandCfg(
        asset_name="robot",
        ...
        ranges=commands_cfg.GaitCommandCfg.Ranges(
            lin_vel_x=(-2.0, 6.0),
            lin_vel_y=(-1.5, 1.5),
            ang_vel_z=(2.0, 2.0),
...
class RewardsCfg:
    ...
    foot_clearance = RewardTermCfg(
        func=gait_rewards.foot_clearance_reward,
        weight=2.0,
        params={
            "std": 0.05,
    ...
    joint_pos = RewardTermCfg(
        func=gait_rewards.joint_position_penalty,
        weight=-0.7,
        params={
            "asset_cfg": SceneEntityCfg("robot"),
...
@configclass
class GaitEnvCfg(spot_env_cfg.SpotFlatEnvCfg):
...
class GaitEnvCfg_PLAY(GaitEnvCfg):
